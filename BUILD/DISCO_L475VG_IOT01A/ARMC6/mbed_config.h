...
#define BLE_BUTTON_PIN_NAME                                                   USER_BUTTON                                                                                      // set by application[DISCO_L475VG_IOT01A]
#define BLE_BUTTON_PIN_PULL                                                   PullNone                                                                                         // set by application
...
#define MBED_CONF_APP_SERVER_IP_3                                             43                                                                                               // set by application
#define MBED_CONF_APP_SERVER_IP_4                                             171                                                                                              // set by application
#define MBED_CONF_APP_WIFI_PASSWORD                                           "a123456789"                                                                                     // set by application
#define MBED_CONF_APP_WIFI_SSID                                               "ma femme est trop belle"                                                                        // set by application
